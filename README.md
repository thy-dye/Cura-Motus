...
- Spoken, out-loud rep counting and motivational cues to keep users goign through a set
...
* will add user input an dother screenshots *
...
- [YouTube Data API v3](https://developers.google.com/youtube/v3) (real-time pose estimation)
- Python 3
- Flask
